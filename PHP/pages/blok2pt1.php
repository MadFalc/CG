...
<p><span style="font-weight: bold">Waar wordt het “$this” keyword voor gebruikt?</span><br><span style="font-size:18px">
                Wordt gebruikt IN methods om te refereren naar de huidige
                object.</span></p>
...
<p><span style="font-weight: bold">Welke drie Access Modifier bestaan er?</span><br><span style="font-size:18px">
                Public, protected en private.</span></p>
...
<p><span style="font-weight: bold">Hoe kan je Inherited Methods Overridden? Wat is het nu hiervan denk
                ...
                intro
                functie.</span></p>
<p><span style="font-weight: bold">Waar wordt de Final keyword voor gebruikt?</span><br><span style="font-size:18px">
                Wanneer een property of method final toegewezen krijgt, dan kan
                deze onmogelijk ge-enherit worden. In de voorbeelden op w3 resulteert dit in een
                error.</span></p>
<br>
<h2>Opdracht: 1.6 - Class Constants</h2>
<p><span style="font-weight: bold">Wat is het nut van een Class Constant?</span><br><span style="font-size:18px"> Als ik
                de beperkte informatie hierover op w3 begrijp, is het
                niet
