...
<body>
    ...
    <div class="main">
        ...
        <p><span style="font-weight: bold">Leg in je eigen woorden uit wat het verschil is tussen flat PHP en Object
                Oriented Programming?</span><br><span style="font-size:18px">Let wel,
                eigen woorden: Ik heb het idee dat de OOP op een vergelijkbare manier werkt als classes in CSS/html. Je
                maakt
        ...
        <p><span style="font-weight: bold">Leg in je eigen woorden uit welke vier voordelen Object Oriented Programming
                ...
                makkelijker uit te voeren. 4. Niet alleen hoef je jezelf niet alsmaar te herhalen, maar dit zorgt er ook
                voor
                dat de code makkelijker te de-buggen is.</span></p>
        <p><span style="font-weight: bold">Leg in je eigen woorden uit wat de twee hoofdonderdelen zijn van Object
                Oriented Programming?</span><br><span style="font-size:18px"> Classes en
                objects. Een class is dus wat ik met CSS vergeleek, een pakketje met allemaal bruikbare onderdelen. De
                object
                zijn deze onderdelen. Dit kunnen variabelen met berekeningen zijn, of functies die vervolgens toegepast
                worden.
                Enz enz.</span></p>
        <p><span style="font-weight: bold">Leg in je eigen woorden uit wat het verschil is tussen een Class en een
                Object?</span><br><span style="font-size:18px"> Ik hoop dat ik deze vraag
                duidelijk genoeg heb beantwoord hierboven.</span></p>
        <p><span style="font-weight: bold">Leg in je eigen woorden uit wat er overgeërfd wordt van een Class als een
                ...
                properties.</span></p>
        <p><span style="font-weight: bold">Bedenk zelf een voorbeeld van een Class en bijbehorende Objecten anders dan
                afgebeeld op W3SCHOOLS.</span><br><span style="font-size:18px"> Class:
                Games. Objects: Mario Sunshine, Bloodborne, Shadow of the Colossus en Doki Doki Literature Club.</span>
        </p>
        <br>
        <h2>Opdracht: 1.2 - Classes and Objects</h2>
        <p><span style="font-weight: bold">Objecten erven dingen van elkaar over. Leg uit in je eigen woorden uit wat
                het verschil is tussen objecten?</span><br><span style="font-size:18px">
                Je kunt meerdere objecten maken op basis van een class. Je kunt deze objecten andere namen geven dan
                elkaar en
                dan de class. Vervolgens kun je de veriabelen/properties binnen je objecten aanpassen. Je verandert dan
                deze
        ...
        <p><span style="font-weight: bold">Wat is de meest basic Syntax definitie van een Class? Uit welke drie
                ...
                className {Properties en methods}. Zo ongeveer. 1. Je roept aan dat je een class aanmaakt. 2. Deze
                krijgt een
                naam waarmee je de class later weer op kan roepen/een object uit kan maken. 3. Properties en methods die
                in deze
                class komen te zitten. </span></p>
        <p><span style="font-weight: bold">Hoe worden variables en functions in een Class genoemd?</span><br><span
                style="font-size:18px"> Properties en methods.</span></p>
        <p><span style="font-weight: bold">Uit welke twee verschillende soorten fundamentele onderdelen kan de body van
                een Class bestaan?</span><br><span style="font-size:18px"> Volgens mij
                is het antwoord weer properties en methods.</span></p>
        <p><span style="font-weight: bold">Hoeveel objects kunnen er van een Class gemaakt worden?</span><br><span
                style="font-size:18px"> Minstens 1.</span></p>
        <p><span style="font-weight: bold">Welke keyword gebruik je om je object mee aan te maken?</span><br><span
                style="font-size:18px"> $naam = new className();. Keyword is new, dacht ik?
            </span></p>
        <p><span style="font-weight: bold">Waar wordt het “$this” keyword voor gebruikt?</span><br><span
                ...
                object.</span></p>
        <p><span style="font-weight: bold">Hoe kan je een property van binnen in de Class veranderen versus buiten de
        ...
        <p><span style="font-weight: bold">Leg uit waar een Constructor voor gebruikt wordt en wat het voordeel
                ...
                een parameter (of meer) heeft die je invult wanneer je de functie oproept, heb je bij een class met de
                construct
                dat je twee 'parameters' die de properties aanpast. In deze voorbeelden wordt construct gebruikt om met
                een
                functie direct twee parameters ($name en $color) toe te wijzen aan met name en color. Ik vergeet het
                aller
                belangrijkste bijna: wanneer een object wordt aangemaakt van de class, dan wordt een functie met
                construct
                direct aangeroepen. Dit kan dus waarschijnlijk ook op andere manier gebruikt worden dan alleen het
                toewijzen van
                parameters.</span></p>
        ...
        <p><span style="font-weight: bold">Wat zijn hun verschillende rollen?</span><br><span style="font-size:18px"> Ze
        ...
        <p><span style="font-weight: bold">Wat is Inheritance?</span><br><span style="font-size:18px"> When a class
                derives from another class.</span></p>
        <p><span style="font-weight: bold">Wat is het verschil tussen een Child Class en een Parent
                Class?</span><br><span style="font-size:18px"> De child heeft alles geërfd van de parent,
                maar vervolgens kun je de child aanpassen. Vervolgens zijn ze niet hetzelfde meer.</span></p>
        <p><span style="font-weight: bold">Welke keyword wordt gebruikt om aan te geven dat er Inheritance plaatsvindt?
                Wat is de basis Syntax van
                Inheritance in zijn geheel?</span><br><span style="font-size:18px"> extends. class naamChildClass
        ...
        <p><span style="font-weight: bold">Hoe kan je Inherited Methods Overridden? Wat is het nu hiervan denk
                ...
                volledig nieuwe class geschreven, in principe. Maar het voorbeeld laat zien dat het letterlijk OVER de
                andere
                dingen heenschrijft. Zo voegt het de propertie weight toe, maar verandert het ook de intro
                functie.</span></p>
        <p><span style="font-weight: bold">Waar wordt de Final keyword voor gebruikt?</span><br><span
                ...
                deze onmogelijk ge-enherit worden. In de voorbeelden op w3 resulteert dit in een error.</span></p>
        <br>
        <h2>Opdracht: 1.6 - Class Constants</h2>
        <p><span style="font-weight: bold">Wat is het nut van een Class Constant?</span><br><span
                style="font-size:18px"> Als ik de beperkte informatie hierover op w3 begrijp, is het niet
                anders dan andere constants. Het komt eropneer dat de constant aangemaakt wordt en vervolgens nooit meer
                veranderd wordt. Ik weet niet of dit overdraagd naar een child, maar het nut is dat als iets altijd
                hetzelfde
                werkt of is, dat dit ook niet veranderd kan worden en dus beperk je hiermee de mogelijkheid tot
                fouten.</span></p>
        <p><span style="font-weight: bold">Hoe declareer je een Class Constant?</span><br><span style="font-size:18px">
                'const' vóór je 'variabele' of property. Dit is dan geen variabele meer,
                maar een constante.</span></p>
        <p><span style="font-weight: bold">Hoe verschilt een Class Constant van een Class Property?</span><br><span
                style="font-size:18px"> Dat deze niet meer veranderd kan worden. Een normale
        ...
        <p><span style="font-weight: bold">Hoe access je een Class Constant van buiten de Class?</span><br><span
                ...
                class classnaam::constantnaam gebruikt om de constant in de class aan te roepen.</span></p>
        ...
        <p><span style="font-weight: bold">Wat is het verschil tussen een Static Method en een reguliere Class
                ...
                instance/object aangemaakt worden van een class voor de inhoud gebruikt kan worden. Wanneer een
                onderdeel van
                een class static is, dan kan deze direct gebruikt/aangeroepen worden zonder eerst een instance of object
                te
                maken van de class. Ook kan een static method gebruikt worden in een andere method, maar ook binnen
                dezelfde
        ...
        <p><span style="font-weight: bold">Hoe gebruik je de Static Method?</span><br><span style="font-size:18px"> Met
        ...
        <p><span style="font-weight: bold">Wat is het verschil tussen een Static Property en een reguliere
                ...
                voor de classes. Gebruik static zodat properties op andere plekken gebruikt kunnen worden.</span></p>
        <p><span style="font-weight: bold">Hoe declareer je een Static Property?</span><br><span style="font-size:18px">
                Ook op dezelfde manier. Door static voor de declared naam van de
                property te zetten.</span></p>
        <p><span style="font-weight: bold">Hoe gebruik je een Static Property <b>binnen</b> een Class?</span><br><span
                style="font-size:18px"> className::$propertyName; , maar in dit geval kun
                je ook 'this' doen ipv 'className'.</span></p>
        <p><span style="font-weight: bold">Hoe gebruik je een Static Property <b>buiten</b> een Class?</span><br><span
                style="font-size:18px"> className::$propertyName;</span></p>
        <br>
    </div>
